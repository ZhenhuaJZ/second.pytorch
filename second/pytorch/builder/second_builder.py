...
def build(model_cfg: second_pb2.VoxelNet, voxel_generator,
    ...
    net = VoxelNet(
        ...
        learned_kernel_size=model_cfg.voxel_feature_extractor.learned_descriptor_feature.kernel_size,
        learned_num_filters=model_cfg.voxel_feature_extractor.learned_descriptor_feature.num_filters,
        learned_padding=model_cfg.voxel_feature_extractor.learned_descriptor_feature.padding,
