...
def build(model_cfg: second_pb2.VoxelNet, voxel_generator,
    ...
    net = VoxelNet(
        ...
        descriptor_feature_name=model_cfg.voxel_feature_extractor.descriptor_feature.module_class_name,
        learned_descriptor_name=model_cfg.voxel_feature_extractor.learned_descriptor_feature.module_class_name,
        learned_kernel_size=list(model_cfg.voxel_feature_extractor.learned_descriptor_feature.kernel_size),
        learned_num_filters=list(model_cfg.voxel_feature_extractor.learned_descriptor_feature.num_filters),
        learned_padding=list(model_cfg.voxel_feature_extractor.learned_descriptor_feature.padding),
